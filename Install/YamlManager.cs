...
namespace Netcad.NDU.GatewayUpdateAgent.Install {
    internal class YamlManager {
        ...
        private const string Key_ConfigVersion = "configVersion";
        private const string Key_Config = "configuration";
        private const string Key_PackVersion = "packVersion";
        private const string Key_UpdateAgentVersion = "updateAgentVersion";
        ...
        public YamlManager(string fn, string updateAgentVersion, ILogger logger) {
            this.logger = logger;
            this.fn = fn;
            this.updateAgentVersion = updateAgentVersion;
        }
