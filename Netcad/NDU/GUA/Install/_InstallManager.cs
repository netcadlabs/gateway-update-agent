...
// {
//     public class _InstallManager : IInstallManager
//     {
//         private readonly ISettings settings;
//         private readonly ILogger logger;
//         private readonly string guaVersion;
//         private readonly string installedArrFn;
//         public _InstallManager(ISettings settings, ILogger<InstallManager> logger)
//         {
...
//                     logger.LogInformation($"Deactivating pack: {dir} -> {dir1}");
...
//                             }
//                         }
//                     Helper.MoveDirectory(dir, dir1, false);
//                 }
//                 return true;
//             }
//             catch (Exception ex)
...
//             }
//         }
//         private bool activatePackage(string type, string id, Dictionary<string, Exception> errors)
//         { //*****
//             try
//             {
//                 string dir = getPackDeactivatedDir(type, id);
//                 if (Directory.Exists(dir))
//                 {
//                     string dir1 = getPackInstallDir(type, id);

//                     logger.LogInformation($"Activating pack: {dir} -> {dir1}");

//                     PackInfoJson info;
//                     if (PackInfoJson.TryParse(dir, out info))
//                         foreach (var copyItem in info.copy)
//                         {
//                             string source = Path.Combine(dir, copyItem.source);
//                             if (Directory.Exists(source))
//                             {
//                                 Helper.MoveDirectory(source, copyItem.destination, false);
//                             }
//                             else if (File.Exists(source))
//                             {
//                                 File.Move(source, copyItem.destination);
//                             }
//                         }
//                     Helper.MoveDirectory(dir, dir1, false);
//                 }
